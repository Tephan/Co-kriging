...
dato <- read.csv('C:\\Users\\tepha\\Desktop\\Se馻les\\KRIGING\\S5-d1\\S5-d1.csv')
...
#Beta Method 2
#m <- vgm(psill=0.0058,model="Exp",range=1.2, nugget=0.00001)
#Alfa Method 1
#m <- vgm(psill=0.001,model="Exp",range=1, nugget=0.000001)
#Delta Method 2
#m <- vgm(psill=0.015,model="Exp",range=1.5, nugget=0.0002)
#Tetha method 2
#m <- vgm(psill=0.0045,model="Exp",range=1, nugget=0.00005)
#Gamma method 2
