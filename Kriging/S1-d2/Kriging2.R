...
dato <- read.csv('C:\\Users\\tepha\\Desktop\\Se馻les\\KRIGING\\Sujeto2\\Eleccion1_Bandas.csv')
...
v = variogram(Beta~1, data=dato)
#Beta Method 2
m <- vgm(psill=0.0002,model="Exp",range=1, nugget=0.0001)
#Alfa Method 0
#m <- vgm(psill=0.0007,model="Gau",range=2, nugget=0.00001)
#Delta Method 2
#m <- vgm(psill=0.005,model="Gau",range=1, nugget=0.0001)
#Tetha method 0.8
#m <- vgm(psill=0.0045,model="Gau",range=2, nugget=0.0001)
#Gamma method 2
#m <- vgm(psill=0.03,model="Gau",range=2, nugget=0.00001)
