...
dato <- read.csv('C:\\Users\\tepha\\Desktop\\Se馻les\\KRIGING\\Luis-d2\\Luis-d2.csv')
...
#Beta Method 2
#m <- vgm(psill=0.0003,model="Sph",range=1, nugget=0.0001)
#Alfa Method 2
#m <- vgm(psill=0.00083,model="Exp",range=2, nugget=0.00001)
#Delta Method 2
m <- vgm(psill=0.008,model="Sph",range=2, nugget=0.0001)
#Tetha method 0.5
#m <- vgm(psill=0.0045,model="Sph",range=2, nugget=0.0001)
#Gamma method 2
#m <- vgm(psill=0.031,model="Sph",range=2, nugget=0.00001)
