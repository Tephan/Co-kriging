...
dato <- read.csv('C:\\Users\\tepha\\Desktop\\Se馻les\\KRIGING\\S3-d1\\S3-d1.csv')
...
#Beta Method 0
#m <- vgm(psill=0.0053,model="Exp",range=1.2, nugget=0.00001)
#Alfa Method 2
#m <- vgm(psill=0.0035,model="Sph",range=2, nugget=0.000001)
#Delta Method 2
m <- vgm(psill=0.0255,model="Exp",range=1.5, nugget=0.0002)
#Tetha method 0
#m <- vgm(psill=0.0104,model="Gau",range=2, nugget=0.00005)
#Gamma method 0 Gau
#m <- vgm(psill=0.03,model="Exp",range=1, nugget=0.0004)
