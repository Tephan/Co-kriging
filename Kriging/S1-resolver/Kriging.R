...
dato <- read.csv('C:\\Users\\tepha\\Desktop\\Se馻les\\KRIGING\\Luis-resolver\\luis-resolver.csv')
...
#Beta Method 2
#m <- vgm(psill=0.0026,model="Exp",range=2, nugget=0.00001)
#Alfa Method 2
#m <- vgm(psill=0.001,model="Sph",range=2, nugget=0.000001)
#Delta Method 2
#m <- vgm(psill=0.02,model="Exp",range=1.5, nugget=0.0002)
#Tetha method 2
#m <- vgm(psill=0.0015,model="Sph",range=2, nugget=0.00005)
#Gamma method 0 
m <- vgm(psill=0.00068,model="Gau",range=1, nugget=0.0001)
